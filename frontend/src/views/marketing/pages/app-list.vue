<template>
  <div v-loading="loading" class="app-box">
    ...
    <div :class="{'app-card': true, 'app-active': AppId === app.app_id}" @click="handleAppChange(app.app_id)" v-for="app in appList.list">
