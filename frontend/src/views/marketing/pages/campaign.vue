<template>
  <el-row>
    ...
    <el-col :span="24" v-else>
      ...
      <el-button icon="el-icon-close" size="mini" plain v-if="openSetting" @click="openSetting = false">取消关联</el-button>
    </el-col>
...
export default {
  ...
  methods: {
    ...
    confirmRelation() {
      ...
      this.campaignLoading = true
      campaignBindApp(this.relationForm)
        .then((res) => {
