  ...
  <el-row>
    <el-col :span="24" class="search-container">
      <el-form ref="_search" :model="search" inline size="small">
        <el-form-item>
          <el-date-picker v-model="search.date_range" :picker-options="pickerOptions" class="w230" :clearable="false" value-format="yyyyMMdd"
            type="daterange" start-placeholder="开始日期" end-placeholder="结束日期" />
        </el-form-item>
        <el-form-item>
          <el-select v-model="search.state" placeholder="数据维度" class="w200">
