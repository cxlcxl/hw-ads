  ...
  children: [
    {
      ...
      meta: { title: "计划列表", auth: "marketing/campaign" },
    },
    {
      path: "adgroup",
      name: "AdgroupList",
      component: () => import("@v/marketing/adgroup"),
      meta: { title: "任务列表", auth: "marketing/adgroup" },
    },
    {
      path: "creative",
      name: "CreativeList",
      component: () => import("@v/marketing/creative"),
      meta: { title: "创意列表", auth: "marketing/creative" },
    },
    {
      hidden: true,
      path: "adgroup-create",
      ...
      meta: { title: "任务创建", auth: "marketing/adgroup-create" },
    },
  ],
};
